locals {
  ...
  training_data_s3_uri    = "s3://${var.data_bucket_name}/${var.s3_date_directories_prefix}${var.training_data_prefix}"
  inference_inputs_s3_uri = "s3://${var.data_bucket_name}/${var.s3_date_directories_prefix}${var.inference_inputs_prefix}"
  predictions_s3_uri      = "s3://${var.data_bucket_name}/${var.s3_date_directories_prefix}${var.predictions_prefix}"
  artifacts_s3_uri        = "s3://${var.data_bucket_name}/${var.s3_date_directories_prefix}${var.artifacts_prefix}"
  endpoint_logs_s3_uri    = "s3://${var.data_bucket_name}/${var.s3_date_directories_prefix}${var.endpoint_logs_prefix}"
